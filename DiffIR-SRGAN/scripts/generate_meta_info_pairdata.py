...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--input',
        nargs='+',
        default=['/mnt/bn/xiabinsr/datasets/DF2K/DF2K_sub', '/mnt/bn/xiabinsr/datasets/DF2K/LR_bicubic_sub/X4'],
    ...
    parser.add_argument(
        '--meta_info',
        type=str,
        default='/mnt/bn/xiabinsr/ICCV-SRGAN/KDSR-v9/datasets/meta_info/meta_info_DF2K_sub_pair.txt',
