...
- **August 28, 2023:** For real-world SR tasks, we released a version that is more focused on perception rather than the PSNR version (Perhaps there will be more artifacts)， which can be used for AIGC SR. 
