...
from saicinpainting.training.losses.feature_matching import feature_matching_loss, masked_l1_loss, KDLoss
...
class SDefaultInpaintingTrainingModule(SBaseInpaintingTrainingModule):
    ...
    def forward(self, batch):
        ...
        if self.training:
            _, batch['fea_S1'] = self.generatorS1.E(masked_img,img)
