...
class SBaseInpaintingTrainingModule(ptl.LightningModule):
    def __init__(self, config, use_ddp, *args,  predict_only=False, visualize_each_iters=100,
                 ...
                 average_generator_period=10, store_discr_outputs_for_vis=False, generatorS2_path=None, generatorS1_path=None,
                 **kwargs):
        ...
        self.generatorS1 = make_generator(config, **self.config.generatorT)
        if generatorS2_path:
